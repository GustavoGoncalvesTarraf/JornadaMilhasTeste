...
namespace JornadaMilhas.Test.Integracao
{
    ...
    {
        public JornadasMilhasContext Context { get; private set; }
        ...
        public async Task InitializeAsync()
        {
            ...
            var options = new DbContextOptionsBuilder<JornadasMilhasContext>()
                .UseSqlServer(_msSqlContainer.GetConnectionString())
                .Options;

            Context = new JornadasMilhasContext(options);
